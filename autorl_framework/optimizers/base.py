...
class BaseSimpleOptimizer(ABC):
    """
    Base para otimizadores simples (Grid, Random, Bayesian), apenas com interface de otimização.
    """
    def __init__(self, param_grid, eval_func):
